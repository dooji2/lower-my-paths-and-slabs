package com.dooji.lmps.neoforge.config;
    ...
    public static Screen build(Screen parent) {
        ...
        return YetAnotherConfigLib.createBuilder()
            ...
            .save(() -> {
                ...
                PacketDistributor.sendToServer(new PermissionLevelUpdatePayload(pendingLevel.get()));
                LMPSClient.setRequiredPermissionLevel(pendingLevel.get());
                PacketDistributor.sendToServer(new OffsetSupportsUpdatePayload(pendingSupports));
